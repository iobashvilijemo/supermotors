const translations = {
  ...
  ka: {
    ...
    servicesIntro: "ჩვენი მიზანია მომხმარებელს კონკურენტულ ფასად შევთავაზოთ საქართველოს ბაზარზე არსებული ხელმისაწვდომი სათადარიგო ნაწილები.",
    serviceRepairTitle: "ყველა ბრენდი და კატეგორია",
    serviceRepairText: "ახალი ავტონაწილები, რომელიც ხელმისაწვდომია საქართველოს ბაზარზე.",
    ...
    serviceGearboxText: "ტრანსმისიის ნაწილები ხარისხიანად შეკეთებისთვის.",
    ...
    orderStepTwoText: "ვამოწმებთ საწყობში ან პარტნიორ ორგანიზაციებში ხელმისაწვდომ ახალ ვარიანტებს.",
    ...
    experienceTextTwo: "ჩვენ ვმუშაობთ სახელმწიფო ორგანიზაციებთან და წლების განმავლობაში ჩვენს გუნდს შეკეთებული აქვს 1,000,000-ზე მეტი ავტომობილი. ეს გამოცდილება გვეხმარება სწორი ნაწილების რეკომენდაციაში და მათ გარანტიით უზრუნველყოფაში, როცა შეცვლა ჩვენს სერვისში ხდება.",
